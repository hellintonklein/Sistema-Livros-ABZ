...
?>
                <td class="actions" style="white-space:nowrap">
				 ...
				 <CakePHPBakeOpenTag= $this->Html->link(__(''), ['action' => 'view',  <?= $pk ?>],
			            ['class'=>'btn btn-default btn-xs glyphicon glyphicon-search',
						'data-tooltip'=>'tooltip',
						'title'=> 'Visualizar']) CakePHPBakeCloseTag> 
					
                    <CakePHPBakeOpenTag= $this->Html->link(__(''), ['action' => 'edit', <?= $pk ?>],
						['class'=>'btn btn-primary btn-xs glyphicon glyphicon-edit',
						'data-tooltip'=>'tooltip',
						'title'=> 'Editar']) CakePHPBakeCloseTag>
                    <CakePHPBakeOpenTag= $this->Form->postLink(__(''), ['action' => 'delete',  <?= $pk ?>], 
						['confirm' => 'Confirma a exclusão', 'class'=>'btn btn-danger btn-xs glyphicon glyphicon-remove', 
						'data-tooltip'=>'tooltip',
						'title'=> 'Excluir']) CakePHPBakeCloseTag>
